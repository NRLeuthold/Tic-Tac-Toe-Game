...
BG = pygame.transform.scale(pygame.image.load(os.path.join("Assets/Board.png")).convert_alpha(), (WIDTH, HEIGHT))

PlayX = pygame.image.load("Assets/X.png").convert_alpha()
PlayX = pygame.transform.scale(PlayX, (20, 20))

PlayO = pygame.image.load("Assets/O.png").convert_alpha()
PlayO = pygame.transform.scale(PlayO, (20, 20))

FinX = pygame.image.load("Assets/X.png").convert_alpha()
FinX = pygame.transform.scale(FinX, (125, 125))

FinO = pygame.image.load("Assets/O.png").convert_alpha()
